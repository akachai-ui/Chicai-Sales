          ...
          <div className="p-4 sm:p-5 border-b border-slate-100 bg-slate-50/80">
            ...
            >
              <span className="flex items-center space-x-1.5 truncate">
                <span>🏛️</span>
                <span className="truncate">ดูข้อมูลนิติบุคคล DBD DataWarehouse</span>
              </span>
          ...
          <div className="p-6 overflow-y-auto flex-1 space-y-6 text-sm text-slate-700">
            ...
            {activeTab === 'timeline' && (
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {!showAddForm && (
                    <button
                      ...
                      className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-[#1b9b8e] hover:bg-[#148277] text-white font-semibold text-xs shadow-sm transition-all"
                    >
                ...
                {showAddForm && (
                  <form onSubmit={handleAddActivity} className="p-4 rounded-2xl bg-teal-50/50 border border-teal-200/80 space-y-4 animate-in fade-in duration-150">
                    <div className="flex items-center justify-between border-b border-teal-100 pb-2">
                      <span className="text-xs font-bold text-[#144641] flex items-center space-x-1.5">
                        <Sparkles className="w-3.5 h-3.5 text-[#1b9b8e]" />
                          ...
                          return (
                            <button
                              ...
                              className={`p-2 rounded-xl text-center text-xs font-semibold border transition-all ${
                                isSelected
                                  ? 'bg-[#1b9b8e] text-white border-[#1b9b8e] shadow-sm'
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full text-xs p-2.5 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#1b9b8e] outline-none"
                        />
                      </div>
                      <div>
                        <label className="block text-xs font-medium text-slate-700 mb-1">
                    ...
                    <div className="p-3 bg-white rounded-xl border border-teal-100 space-y-2">
                      <span className="text-xs font-semibold text-slate-800 flex items-center space-x-1.5">
                        <CalendarDays className="w-3.5 h-3.5 text-[#1b9b8e]" />
                    ...
                    <div className="flex items-center justify-end space-x-2 pt-1">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1.5 px-4 py-2 bg-[#1b9b8e] hover:bg-[#148277] text-white text-xs font-bold rounded-lg shadow-sm disabled:opacity-50"
                      >
                ...
                <div className="space-y-4">
                  {loadingActivities ? (
                    <div className="py-8 text-center space-y-2">
                      <Loader2 className="w-6 h-6 animate-spin text-[#1b9b8e] mx-auto" />
                      ...
                      {activities.map((act, index) => {
                        ...
                        return (
                          <div key={act.id || index} className="relative group">
                            {/* Dot on Timeline */}
                            <div className="absolute -left-[31px] top-1 w-4 h-4 rounded-full bg-[#1b9b8e] border-4 border-white shadow-sm" />

                            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-2 hover:border-teal-300 transition-colors">
                              <div className="flex flex-wrap items-center justify-between gap-1">
                                <div className="flex items-center space-x-2">
                                  <span className="px-2.5 py-0.5 rounded-full text-[11px] font-bold bg-teal-100 text-[#148277] border border-teal-200">
                                    {act.activity_type}
                                  </span>
                                  {act.contact_person && (
